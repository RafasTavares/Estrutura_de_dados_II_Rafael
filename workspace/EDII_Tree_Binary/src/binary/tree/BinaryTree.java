...
public class BinaryTree {
	 ...
	 *
	 * @param newNode
	 *            Node to be inserted into this Tree
	 */
	 ...
	 *
	 * @param value
	 *            Value to be searched in this Tree
	 ...
	 *
	 * @param value
	 *            Value to be searched within this Tree
	 ...
	 *
	 * @param currentNode
	 *            Current node we are comparing to newNode
	 * @param newNode
	 *            New node that is to be inserted
	 */
